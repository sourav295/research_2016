...
class PacketGenerator(object):
    ...
    def run(self):
        ...
        while self.env.now < self.finish:
            ...
            random_prio = random.randint(1,3)
...
#class SwitchPort(object):
    ...
    def run(self):
        ...
        while True:
            #msg = (yield self.store.get())
            store = (self.routing_processor.get_store(self))
            priority_item = (yield store.get())
            msg = priority_item.item
    ...
    def run(self):
        ...
        for queue_index in cycle(range(nOfQueues)):
            ...
            if msg_retreived:                                   #now - transmit msg
                ...
                msg.log("Packet on out port at {}".format(env_time_before_transmission))
